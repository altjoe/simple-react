...
Horizontal.args = {
    wrapper : 'rounded-2xl overflow-clip',
    row : tw('flex flex-col group rounded-2xl bg-blue-50 m-2',
             'md:rounded-none md:m-0 md:flex-row md:flex-1'),
    header : 'self-center flex-1',
    headercontainer : tw('flex self-center w-4/5 rounded-2xl bg-blue-200 border-b border-blue-200 m-2 p-2', 
    ...
    inputdisplay : tw(' flex flex-1 p-1 border-2 border-white rounded-2xl',
                        'hover:bg-blue-100', 
